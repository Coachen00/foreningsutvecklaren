...
export const MISSION_AREAS: MissionArea[] = [
  {
    ...
    lead: "Riktade insatser där behoven är störst. En bättre väg bär den stora samhällsnyttan — inkludering, trygghet och meningsfull fritid i prioriterade områden.",
    bearing: "Bär samhällsnyttan",
    contains: [
      "Girls FC — som konkret case för flickfotboll i prioriterade områden",
      "Hisingsbacka, Tynnered, Biskopsgården och andra prioriterade geografier",
      "Föreningsutvecklare och fotbollsutvecklare inom satsningen",
      "Partnerarbete kopplat till riktade insatser",
      "Pengar via stiftelser, bostadsbolag och samhällsaktörer som stärker prioriterade områden",
      "Samverkansdokument, förstudier och återrapportering",
      "Lokala förebilder och fler barn i meningsfull fritid",
      "Områdestrygghet och samhällsnytta kopplat till prioriterade områden",
    ],
    crossLinks: [
      {
  ...
  },
  {
    ...
    lead: "Skolan som väg in i fotboll. FU Skola binder ihop GFF, skolor, föreningar, RF-SISU, Göteborgs Stad och GIS — och låter barn nås där de redan är.",
    bearing: "Bär skola–förening-bron",
    contains: [
      "Skolbollen och fotbollsprofil åk 7–9",
      "Onboarding av skolor och kontakt med rektorer, skolpersonal och kommun",
      "Samverkan mellan GFF, skolor, föreningar, RF-SISU, Göteborgs Stad och GIS",
      "Barn som nås via skolan — uppföljning av skolrelaterad fotbollsverksamhet",
  ...
  },
  {
    ...
    lead: "Den generella motorn för föreningsutveckling. Föreningslyftet är arbetet, Kvalitetsklubb är ramverket. Här byggs struktur, ledarskap och kultur som håller över säsonger.",
    bearing: "Bär struktur, kvalitet och föreningsmotor",
    contains: [
      "Föreningslyftet som huvudmotor",
      "Kvalitetsklubb som ramverk och styrsystem",
      "Nulägesanalys, handlingsplaner och uppföljning",
      "Föreningsstruktur, styrelsearbete, årsmöten, stadgar och verksamhetsplan",
      "Matchklimat, Trygg Fotboll, multiidrott och övergångspolicy",
      "Ledarförsörjning kopplad till föreningens struktur",
